    ...
    return (
        <footer class="">
            <div class="w-full  mx-auto px-8 py-4 md:py-6 ">
                ...
                <span class="block text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 <a href="#" class="hover:underline">Kittitat - Phithatsanan - Woradon Senior project™</a>. All Rights Reserved.</span>
            </div>
        </footer>
    );
}