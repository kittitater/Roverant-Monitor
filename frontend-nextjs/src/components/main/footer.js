  ...
  return (
    <>
      <footer className="bg-white w-full">
        <div className="  mx-auto px-8 py-4 md:py-6 ">
              ...
              <div className="bg-white px-4 pb-4 pt-5 sm:p-10 sm:pb-4 ">
                <div className="sm:flex sm:items-start">
                  <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                    ...
                    <p className="mb-2">
                      This Privacy Policy explains how data is collected, used,
                      and protected by the Roverant Monitoring Web Application
                      (the “Application”). By using the Application, you agree
                    ...
                    <p className="mb-1">
                      We value your privacy and ensure that your data is shared
                      only under the following conditions:
                    </p>
                    <ul className="mb-1 list-disc list-inside">
                      <li>
                        <strong>With Trusted Service Providers:</strong> Engaged
                        to assist in the operation and maintenance of the
                        Application under strict confidentiality obligations.
                      </li>
                      <li>
                      ...
                      <li>
                        <strong>In Emergency Situations:</strong> When necessary
                        to protect the safety and security of individuals or
                        property.
                      </li>
                    </ul>
                    <p>
                    ...
                    <ul className="mb-1 list-disc list-inside">
                      ...
                      <li>
                        Regular security audits, software updates, and adherence
                    ...
                    <p>
                      ...
                      purposes outlined in this policy or comply with legal and
                      operational requirements. Upon the expiration of retention
                    ...
                    <ul className="mb-1 list-disc list-inside">
                      ...
                      <li>
                        <strong>Correction:</strong> You may request updates to
                        correct inaccurate or incomplete information.
                      </li>
                      <li>
                        <strong>Deletion:</strong> You can request the deletion
                        of your data, subject to any legal or operational
                        obligations.
                      </li>
                    </ul>
                    <p>
                    ...
                    <p>
                      ...
                      changes in legal requirements, technology, or operational
                      practices. Notifications of significant updates will be
                      provided through the Application or via email.
                    </p>
                    ...
                    <p>
                      This Privacy Policy is governed by the applicable laws of
                      [Insert Jurisdiction]. By using the Application, you
            ...
            >
              <div className="bg-white px-4 pb-4 pt-5 sm:p-10 sm:pb-4 ">
                <div className="sm:flex sm:items-start">
                  <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                    <h1 className="text-5xl font-medium mb-8">
                      Roverant - License Agreement
                    </h1>
                    <p>
                      This License Agreement ("Agreement") is a legal agreement
                      between you ("User") and the developers of the Roverant
                      Monitoring Web Application (the "Application"). By using
                      the Application, you agree to be bound by the terms of
                      this Agreement.
                    </p>
                    ...
                    <p>
                      The Application is licensed, not sold. We grant you a
                      limited, non-exclusive, non-transferable, revocable
                      license to use the Application solely for its intended
                      purpose.
                    </p>
                    ...
                    <ul className="list-disc list-inside">
                      <li>
                        ...
                        derivative works based on the Application without prior
                        written consent.
                      </li>
                      <li>
                        You may not reverse engineer, decompile, disassemble, or
                        attempt to discover the source code of the Application.
                      </li>
                      <li>
                      ...
                      <li>
                        You may not use the Application for unlawful or
                    ...
                    <p>
                      ...
                      limited to copyrights, trademarks, and patents, in the
                      Application are owned by the developers. This Agreement
                      does not grant you any ownership rights to the
                      Application.
                    </p>
                    ...
                    <p>
                      ...
                      guarantee that the Application will be uninterrupted,
                    ...
                    <p>
                      ...
                      or revenue, arising out of or related to your use or
                    ...
                    <p>
                      This license is effective until terminated. Your rights
                      under this Agreement will terminate automatically without
                      notice if you fail to comply with its terms. Upon
                      termination, you must cease all use of the Application and
                    ...
                    <p>
                      ...
                      with the laws of [Insert Jurisdiction]. Any disputes
                      arising from this Agreement shall be resolved in the
                    ...
                    <p>
                      For questions regarding this License Agreement, please
                      contact us at:
                    </p>
                    <ul>
                      <li>
