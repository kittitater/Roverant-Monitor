...
import Layout from "@/components/layout";
import ChatComponent from "@/components/Controllerr/chat";
import MotorControl from "@/components/Controllerr/control";
import React, { useEffect, useRef, useState } from "react";

export default function Controllerr() {
  const canvasRef = useRef(null);
  const [wsStatus, setWsStatus] = useState("Connecting...");
  ...
  const wsUrl = "ws://kittitat.trueddns.com:45133/ws/video"; // WebSocket URL
